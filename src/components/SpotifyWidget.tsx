  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col min-w-[100px] sm:min-w-[120px] max-w-[130px] sm:max-w-[150px]">
        <span className={`text-[9px] sm:text-[10px] font-mono font-bold ${track.isPlaying ? 'text-emerald-600 dark:text-emerald-400' : 'text-gray-500 dark:text-gray-400'} uppercase tracking-widest leading-none mb-0.5 sm:mb-1 flex items-center gap-1.5`}>
          {track.isPlaying ? (
        ...
        <span className="text-[11px] sm:text-xs font-bold text-gray-900 dark:text-white truncate" title={track.title}>{track.title}</span>
